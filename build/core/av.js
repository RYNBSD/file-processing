...
class AV extends Core {
  ...
  custom(callback) {
    return __awaiter(this, void 0, void 0, function* () {
      const tmpFile = yield new TmpFile(...this.avs).init();
      const result = yield Promise.all(
        tmpFile.paths.map((path, index) =>
          __awaiter(this, void 0, void 0, function* () {
            return callback(AV.newFfmpeg(path), index);
          }),
        ),
      );
      yield tmpFile.clean();
...
export class Video extends AV {
  ...
  setVideos(callback) {
    return __awaiter(this, void 0, void 0, function* () {
      const videos = yield Promise.all(
        this.avs.map((video, index) =>
          __awaiter(this, void 0, void 0, function* () {
            return callback(video, index);
          }),
        ),
      );
...
export class Audio extends AV {
  ...
  setAudios(callback) {
    return __awaiter(this, void 0, void 0, function* () {
      const audios = yield Promise.all(
        this.avs.map((audio, index) =>
          __awaiter(this, void 0, void 0, function* () {
            return callback(audio, index);
          }),
        ),
      );
