...
export default class CSV extends Core {
  ...
  setCsvs(callback) {
    return __awaiter(this, void 0, void 0, function* () {
      const csvs = yield Promise.all(
        this.csvs.map((csv, index) =>
          __awaiter(this, void 0, void 0, function* () {
            return callback(csv, index);
          }),
        ),
      );
        ...
        this.csvs.map((csv) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            return {
              ...
              columns:
                (_b =
                  (_a = parse === null || parse === void 0 ? void 0 : parse[0]) === null || _a === void 0
                    ? void 0
  ...
  parseAsync(options) {
    return __awaiter(this, void 0, void 0, function* () {
      return Promise.all(
        this.csvs.map((c) =>
          __awaiter(this, void 0, void 0, function* () {
            return CSV.parseAsync(c, options);
          }),
        ),
      );
    });
  ...
  transformAsync(parsed, handler, options) {
    return __awaiter(this, void 0, void 0, function* () {
      return Promise.all(
        parsed.map((p) =>
          __awaiter(this, void 0, void 0, function* () {
            return CSV.transformAsync(p, handler, options);
          }),
        ),
      );
    });
  ...
  stringifyAsync(csvs, options) {
    return __awaiter(this, void 0, void 0, function* () {
      return Promise.all(
        csvs.map((c) =>
          __awaiter(this, void 0, void 0, function* () {
            return CSV.stringifyAsync(c, options);
          }),
        ),
      );
    });
