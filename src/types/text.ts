...
export type BrotliCompressOptions = Parameters<
  typeof zlib.brotliCompressSync
>[1];
...
export type BrotliDecompressOptions = Parameters<
...
export type TextCustomCallback<T> = (
  text: ArrayBuffer,
  index: number
) => Promise<T> | T;
